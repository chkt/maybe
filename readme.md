...
## compose
[`./source/compose.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/compose.ts#L1)
### Functions
```ts
function apply<T, R0, R1>(b:process<T, R0, R1>, a:transform<T, R0>) : transform<T, R1>;
```
## convert
[`./source/convert/index.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/convert/index.ts#L1)
### References
```ts
...
```
## convert/async
[`./source/convert/async.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/convert/async.ts#L1)
### Functions
```ts
...
```
## convert/sync
[`./source/convert/sync.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/convert/sync.ts#L1)
### Functions
```ts
...
```
## flow
[`./source/flow/index.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/flow/index.ts#L1)
### References
```ts
export {
  and as andAsync,
...
```
## flow/async
[`./source/flow/async.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/flow/async.ts#L1)
### Functions
```ts
...
```
## flow/sync
[`./source/flow/sync.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/flow/sync.ts#L1)
### Functions
```ts
...
```
## index
[`./source/index.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/index.ts#L1)
### References
```ts
...
```
## maybe
[`./source/maybe.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/maybe.ts#L1)
### Interfaces
```ts
...
```
## message
[`./source/message.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/message.ts#L1)
### Enumerations
```ts
...
```
## native
[`./source/native/index.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/native/index.ts#L1)
### References
```ts
...
```
## native/async
[`./source/native/async.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/native/async.ts#L1)
### Functions
```ts
...
```
## native/common
[`./source/native/common.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/native/common.ts#L1)
### Type Aliases
```ts
...
```
## native/sync
[`./source/native/sync.ts`](https://github.com/chkt/maybe/blob/8c3794028dc522417a96d7491c3290b91e24e204/source/native/sync.ts#L1)
### Functions
```ts
